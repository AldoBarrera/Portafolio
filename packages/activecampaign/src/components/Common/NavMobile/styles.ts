...
export const NavMobilePrimaryLinks = styled.div.attrs({
  className: 'NavMobile__PrimaryLinks'
})`
  ${({ theme }) => css`
  ...
  `}
`
export const NavMobileSecondaryLinks = styled.div.attrs({
  className: 'NavMobile__NavMobileSecondaryLinks'
})`
  ${({ theme }) => css`
