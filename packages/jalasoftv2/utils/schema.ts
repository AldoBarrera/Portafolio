...
import { SectionProps } from '@/app/ui/components/Common/DynamicComponent'
...
export const getSchema = (page: PageProps) => {
  ...
  return {
    ...
    name: 'Jalasoft',
    url: ORIGIN_PATH,
    logo: `${ORIGIN_PATH}/img/logo-jalasoft.svg`,
    founder: [
      {
        '@type': 'Person',
        name: 'Jorge Lopez',
...
const getCommonBreadcrumbBlogItems = (page: PageProps) => {
...
const getCommonBreadcrumbCategoryItems = (
  blogCategory: string,
...
export const getSchemaBreadcrumbBlogPost = (page: PageProps) => {
...
export const getSchemaBreadcrumbBlogCategory = (page: PageProps) => {
...
export const getSchemaBreadcrumbBlog = (page: PageProps) => {
  return {
    '@context': 'https://schema.org',
    '@type': 'BreadcrumbList',
...
export const getSchemaBreadcrumb = (page: PageProps) => {
...
export const getSchemaBlog = (page: PageProps) => {
  if (page?.parentSlug === 'blog' && page?.sections?.[0]?.name === 'Article') {
    ...
    return {
      ...
      publisher: {
        ...
        logo: {
          '@type': 'ImageObject',
          url: `${ORIGIN_PATH}/img/logo-jalasoft.svg`,
          width: '220',
          height: '47'
        }
      },
